...
public class WaterSkillComponent : DefaultSkillComponent {
    ...
    public override void Initialize(Transform origin, Condition condition) {
        ...
        LearnWaterSkill(_monsterStats, _monster);
    }
    ...
    public override bool UseSkill() {
        ...
        switch (ActiveSkills[randomIdx])
        {
            ...
            //Water Active
            case SkillKind.kSlow: Slow(); break;
    ...
    public override void Slow() {
        GameObject slowObject = SkillPoolManager.Instance.PopSkill(SkillKind.kSlow);
        Slow slow = slowObject.GetComponent<Slow>();
        slow.Slowing(_player);
    }
}
